...
const SOURCE_COLORS: Record<string, string> = {
  ...
  AuthenticJobs: "bg-rose-50 text-rose-700 border-rose-100",
  SmashingMagazine: "bg-fuchsia-50 text-fuchsia-700 border-fuchsia-100",
  WPHired: "bg-sky-50 text-sky-700 border-sky-100",
  LaraJobs: "bg-amber-50 text-amber-700 border-amber-100",
  JustRemote: "bg-violet-50 text-violet-700 border-violet-100",
  SkipTheDrive: "bg-stone-50 text-stone-700 border-stone-100",
  SupportDriven: "bg-green-50 text-green-600 border-green-100",
  EuropeRemotely: "bg-blue-50 text-blue-600 border-blue-100",
  Pangian: "bg-orange-50 text-orange-600 border-orange-100",
  RemoteLeaf: "bg-lime-50 text-lime-600 border-lime-100",
  GoRemote: "bg-teal-50 text-teal-600 border-teal-100",
  ProBlogger: "bg-pink-50 text-pink-600 border-pink-100",
  CrunchBoard: "bg-indigo-50 text-indigo-600 border-indigo-100",
  VentureLoop: "bg-cyan-50 text-cyan-600 border-cyan-100",
  StartupJobs: "bg-yellow-50 text-yellow-600 border-yellow-100",
  HNJobs: "bg-amber-50 text-amber-600 border-amber-100",
  PythonOrg: "bg-sky-50 text-sky-600 border-sky-100",
  DjangoJobs: "bg-emerald-50 text-emerald-600 border-emerald-100",
  RailsJobs: "bg-red-50 text-red-600 border-red-100",
  Coroflot: "bg-violet-50 text-violet-600 border-violet-100",
  Krop: "bg-fuchsia-50 text-fuchsia-600 border-fuchsia-100",
  JSRemotely: "bg-amber-50 text-amber-700 border-amber-200",
  AIJobs: "bg-purple-50 text-purple-600 border-purple-100",
  CryptoJobsList: "bg-emerald-50 text-emerald-700 border-emerald-200",
  Web3Career: "bg-violet-50 text-violet-700 border-violet-200",
  FlutterJobs: "bg-sky-50 text-sky-700 border-sky-200",
  GolangCafe: "bg-cyan-50 text-cyan-700 border-cyan-200",
  GraphQLJobs: "bg-pink-50 text-pink-700 border-pink-200",
  Jobgether: "bg-rose-50 text-rose-600 border-rose-100",
  DynamiteJobs: "bg-orange-50 text-orange-700 border-orange-200",
  TechCareers: "bg-indigo-50 text-indigo-700 border-indigo-200",
  DataScienceJobs: "bg-blue-50 text-blue-700 border-blue-200",
  MLRemote: "bg-purple-50 text-purple-700 border-purple-200",
  Climatebase: "bg-green-50 text-green-700 border-green-200",
  DevOpsCafe: "bg-slate-50 text-slate-600 border-slate-100",
  SecurityJobs: "bg-red-50 text-red-700 border-red-200",
  CloudJobs: "bg-sky-50 text-sky-600 border-sky-200",
  SalesGravy: "bg-yellow-50 text-yellow-700 border-yellow-200",
  GoodGigs: "bg-lime-50 text-lime-700 border-lime-200",
  JobsinTech: "bg-teal-50 text-teal-700 border-teal-200",
  AndroidDev: "bg-green-50 text-green-700 border-green-300",
  iOSJobs: "bg-stone-50 text-stone-600 border-stone-100",
  BlockchainJobs: "bg-amber-50 text-amber-700 border-amber-200",
  Web3Jobs: "bg-fuchsia-50 text-fuchsia-600 border-fuchsia-200",
  ReactJobs: "bg-cyan-50 text-cyan-600 border-cyan-200",
  NodeJobs: "bg-emerald-50 text-emerald-600 border-emerald-200",
  VueJobs: "bg-green-50 text-green-600 border-green-200",
};
