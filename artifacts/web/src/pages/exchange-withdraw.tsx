        ...
        {result ? (
          <Card className="border-0 shadow-lg rounded-2xl overflow-hidden bg-white text-center">
            <CardContent className="p-8 space-y-4">
              ...
              <h2 className="text-xl font-bold text-gray-900">Withdrawal sent</h2>
          ...
          <>
            <Card className="border-0 shadow-md rounded-2xl bg-white">
              <CardContent className="p-5">
                <h2 className="font-bold text-gray-900 mb-1">Where are you withdrawing to?</h2>
                ...
                <div className="space-y-2">
                  {EXCHANGES.map((ex) => (
                    <button
                      ...
                      className="w-full flex items-center justify-between p-4 rounded-xl border border-gray-200 hover:border-[#4DC9EE] hover:bg-[#4DC9EE]/5 transition-all text-left"
                    >
                      <span className="flex items-center gap-3 font-semibold text-gray-900 text-sm">
          ...
          <Card className="border-0 shadow-md rounded-2xl bg-white">
            <CardContent className="p-5 space-y-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold text-gray-900">Withdraw to {exchange.name}</h2>
                  <p className="text-xs text-gray-500">Follow the steps exactly — this keeps your funds safe.</p>
                </div>
              </div>
                  ...
                  {(["USDC", "USDT"] as const).map((t) => (
                    <button
                      ...
                      className={`rounded-xl border p-3 text-sm font-bold transition-all ${
                        token === t ? "border-[#4DC9EE] bg-[#4DC9EE]/5 text-[#1A2B4A]" : "border-gray-200 text-gray-500 hover:border-gray-300"
                      }`}
                    >
                      {t}
              ...
              {/* Address */}
              <div className="space-y-1.5">
                <Label htmlFor="exAddress" className="text-sm font-medium text-gray-700">{exchange.name} deposit address (Celo)</Label>
                <Input
                  id="exAddress"
                  placeholder="0x…"
                  value={address}
                  ...
                  className={`rounded-xl h-11 font-mono text-sm ${
                    address && !addressValid ? "border-red-300" : "border-gray-200 focus:border-[#4DC9EE]"
                  }`}
                />
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  <Label htmlFor="exAmount" className="text-sm font-medium text-gray-700">Amount ({token})</Label>
                ...
                <Input
                  ...
                  className="rounded-xl h-11 border-gray-200 focus:border-[#4DC9EE]"
                />
                {amount && !amountValid && (
              ...
              {/* Safety confirmation */}
              <label className="flex items-start gap-3 cursor-pointer bg-gray-50 rounded-xl p-3.5 border border-gray-100">
                <input
                  type="checkbox"
